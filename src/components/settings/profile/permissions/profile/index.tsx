...
const ProfilePermissionComponent = ({
  openProfile,
  setOpenProfile,
  setOpenContact,
  setOpenMessage,
  ...
  useEffect(() => {
    ...
    const storedPermission = localStorage.getItem("profilePermission");
    if (storedPermission) {
  ...
  const handlePermissionChange = (
    ...
    localStorage.setItem("profilePermission", selectedValue);
  };
  ...
  return (
    <div className={`${styles.profile} ${styles.permission}`}>
      <div className={styles.header}>
        <p className={styles.sec_title}>Profil Fotoğrafı</p>
        <p className={styles.sec_desc}>
          Profil fotoğrafınızı kimlerin görüntüleyebileceğini seçiniz.
        </p>
      </div>
...
export default ProfilePermissionComponent;
